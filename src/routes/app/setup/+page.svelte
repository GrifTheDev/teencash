...
<div class="flex justify-center items-center h-screen">
  <div class="w-1/3">
    ...
    >
      1. Number of Wallets<br />
      <p class="text-sm">
      TeenCash tracks your balances through wallets. Wallets are seperate accounts
      (like cash or card) that are added together to form the master balance (the
